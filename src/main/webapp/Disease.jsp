                ...
                <div class="row mt-2">
                    <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
                        ...
                        <ul class="list-unstyled">
                            <li><a class="link-secondary" href="<%=request.getContextPath()%>/AboutUs" style="font-size: 18px;font-family: 'DM Sans'; text-decoration: none;">About Us</a></li><li><a class="link-secondary" href="ContactUs" style="font-size: 18px;font-family: 'DM Sans'; text-decoration: none;">Contact Us</a></li>
                            <li><a class="link-secondary" href="<%=request.getContextPath()%>/Unani" style="font-family: 'DM Sans';font-size: 18px;text-decoration: none;color: rgb(136,149,160);">Unani</a></li>
                            <li><a class="link-secondary" href="<%=request.getContextPath()%>/History" style="font-size: 18px;font-family: 'DM Sans'; text-decoration: none;">History</a></li>
                            <li><a class="link-secondary" href="<%=request.getContextPath()%>/UnaniTreatment" style="font-size: 18px;font-family: 'DM Sans'; text-decoration: none;">Treatment</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
                        ...
                        <ul class="list-unstyled">
                            <li><a class="link-secondary" href="<%=request.getContextPath()%>/Awards" style="font-family: 'DM Sans';font-size: 18px;text-decoration: none;color: rgb(136,149,160);">Awards</a></li>
                            <li><a class="link-secondary" href="<%=request.getContextPath()%>/PatientRights" style="font-size: 18px;font-family: 'DM Sans'; text-decoration: none;">Patients Rights&nbsp;</a></li>
                            <li><a class="link-secondary" href="<%=request.getContextPath()%>/Confidentiality" style="font-size: 18px;font-family: 'DM Sans'; text-decoration: none;">Confidential</a>ity</li>
                            <li><a class="link-secondary" href="<%=request.getContextPath()%>/CaseStudy" style="font-size: 18px;font-family: 'DM Sans'; text-decoration: none;">Case Study</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
                        ...
                        <hr style="height: 1px;border-width: 2px;">
                        <ul class="list-unstyled">
                            <li><a class="link-secondary" href="<%=request.getContextPath()%>/PatientSupport" style="font-family: 'DM Sans';font-size: 18px;text-decoration: none;color: rgb(136,149,160);">Patient Support</a></li>
                            <li><a class="link-secondary" href="<%=request.getContextPath()%>/PrivacyPolicy" style="font-size: 18px;font-family: 'DM Sans'; text-decoration: none;">Privacy Policy</a></li>
                            <li><a class="link-secondary" href="<%=request.getContextPath()%>/TermsCondition" style="font-size: 18px;font-family: 'DM Sans'; text-decoration: none;">Terms &amp; Conditions</a></li>
                            <li><a class="link-secondary" href="<%=request.getContextPath()%>/Disclaimer" style="font-size: 18px;font-family: 'DM Sans'; text-decoration: none;">Disclaimer</a></li>
                        </ul>
                    </div>
