                            ...
                            <div class="card shadow border-left-primary py-2">
                                <div class="card-body">
                                    <div class="row g-0 align-items-center">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Total Appointment</span></div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-left-success py-2">
                                <div class="card-body">
                                    <div class="row g-0 align-items-center">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>Today's Appointment</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span>0</span></div>
                                        </div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-left-info py-2">
                                <div class="card-body">
                                    <div class="row g-0 align-items-center">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-info fw-bold text-xs mb-1"><span>Total Patients</span></div>
                                            <div class="row g-0 align-items-center">
                                                <div class="col-auto">
                        ...
                        <div class="col">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-primary fw-bold m-0">Today's Appointment</h6>
                                    ...
                                    <div class="table-responsive">
                                        <table id="myTable" class="display">
                                            ...
                                            <%
                                                ...
                                                pst=(PreparedStatement) con.prepareStatement("select * from Bookappointment");
                                                ResultSet rst=null;
                                            ...
                                            %>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><%=rst.getString("Mobileno")%></td>
                                                    <td><%=rst.getString("Doctors")%></td>
                                                    <td><%=rst.getString("Date")+" "+rst.getString("Time")%></td>
                                                </tr>
                                            <%}%>
                                            </tbody>
                                        </table>
...
<%} catch (Exception ee) {
    System.out.println("Exceptions Error is"+ee);
}%>
