                        ...
                        <div class="col">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form>
                                        <div class="row">
                                            <div class="col-lg-6"><input class="form-control" type="text" placeholder="Diseases Id"></div>
                                            <div class="col-lg-6 text-center"><input class="btn" type="submit" style="background: rgb(40,201,85);font-size: 16px;border-radius: 19.6px;color: rgb(255,255,255);"></div>
                                        </div>
                                    </form>
                                </div>
                            </div>
