...
<body>
    <div class="row" style="margin-top: 75px;">
        <div class="col">
            <header><img class="img-fluid" src="assets/img/history%20(1).png"></header>
        </div>
    </div>
