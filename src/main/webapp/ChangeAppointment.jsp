                        ...
                        <div class="col">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-primary fw-bold m-0">Change Appointment</h6>
                                ...
                                <div class="card-body">
                                    <form>
                                        <div class="row">
                                            <div class="col" style="text-align: center;"><input class="form-control" type="text" placeholder="Appountment ID" name="appointmentid"><input class="btn btn-success mt-2" type="submit" value="Search Appointment" style="color: rgb(255,255,255);font-weight: bold;border-radius: 28.6px;"></div>
                                        </div>
                                    </form>
                                    <form>
                                        <div class="row mt-3">
