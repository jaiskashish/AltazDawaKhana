...
<body>
    <div class="row" style="margin-top: 80px;">
        <div class="col">
            <header><img class="img-fluid" src="assets/img/unani%203%20%20.png"></header>
        </div>
    </div>
                ...
                <div class="col">
                    <div class="card shadow" style="border-radius: 15px;">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h4 class="text-center"><span style="color: rgb(83, 100, 116);">UNANI</span></h4>
                                    <p>Unani is a medical science developed by German physician Dr Samuel Hahnemann. It is based on the principle of ‘like cures like’. In simple words, it means that any substance that produces symptoms in a healthy person can cure similar symptoms in a person who is unwell. It is referred to as the ‘Law of Similars’. This idea was understood by Hippocrates (father of medicine) and is also mentioned in ancient Hindu manuscripts. It was Hahnemann, however, who turned it into the science of healing.</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-lg-7">
                                    <h4><span style="color: rgb(83, 100, 116);">Worldwide popularity</span></h4>
                                    <p>Unani is known for its safe and gentle ways of treatment. People across the world prefer unani over conventional medicine, as it has no side-effects, and is non-toxic and non-addictive.<br><br>In the last five years, unani has grown three times faster than allopathy [25-30% annually]. It is presently the 2nd largest system of medicine in the world, according to the World Health Organisation (WHO).<br><br>France is the largest contributor to unani in the world followed by Germany. In England, 42% British physicians refer patients to homeopaths. The Royal family has used unani for three generations. The Queen has carried her 'black box' of ‘white pills’ on her travels. It has been estimated that over 6 million people in the US use unani for self-care, and day-to-day health problems.</p>
                                </div>
                                <div class="col"><img class="img-thumbnail img-fluid" src="assets/img/Unaniimage.png" style="border-radius: 20px;box-shadow: 7px 7px var(--bs-success);"></div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <p><br>In India, over 100 million people depend on unani for health issues. There are around 200,000 registered homeopathic doctors, and approximately 12,000 new homeopathic doctors are registered every year.<br><br>unani is practised in most European countries. It is included in the national health systems of countries like Brazil, Chile, Mexico, Switzerland and United Kingdom. unani is also practiced with good support from the government in countries like UAE, most Asian countries, and in many Middle Eastern countries.<br><br>Apart from curing acute and chronic illnesses, unani has a reputation of providing relief in many difficult as well as rare ailments.<br><br></p>
                                </div>
                            </div>
                        </div>
                    </div>
